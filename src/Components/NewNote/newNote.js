    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <span className="material-icons-outlined btn-edit">edit</span>
          </button>
          ...
          >
            <span className="material-icons-outlined btn-archive">archive</span>
          </button>
          <button
            className="btn-transparent"
            onClick={() => {
          ...
          >
            <span
              className="material-icons-outlined btn-delete"
              onClick={() => {
                deleteNote(note._id, note);
              }}
            >
