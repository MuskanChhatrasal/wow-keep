     ...
     <header className="header cont-shadow" style={{width: '96rem', backgroundColor: 'white'}}>
        ...
        <ul className="header-nav">
            <li style={{marginTop: '0.75rem', cursor: 'pointer'}}>
                    ...
                    {!authState.userID ? <i class="fas fa-user-alt"></i>:
                    `Hello, ${authState.userName}`}
                
            </li>
             <li style={{cursor: 'pointer'}}>
               {authState.userID ?  <a onClick={()=>logout()}>
                    <i class="fas fa-sign-out-alt" style={{marginRight: '0.5rem'}}></i>
                    Logout
                </a>:<Link to='/login'>
                    <i class="fas fa-sign-in-alt" style={{marginRight: '0.5rem'}}></i>
                    Login
                </Link>}
            </li>
            <li>
