    ...
    <main className="label-main m-3">
      <div>
        <div>
          ...
          <div  style={{display: 'flex', gap: '1.5rem', marginLeft: '9rem', marginTop: '2rem'}}>
            <button
          ...
          <div className="spacer-1"></div>
          <div style={{display: 'flex', gap: '1rem', marginLeft: '9rem', marginTop: '2rem'}}>
            <label
              htmlFor="low-to-high"
              className="text-base font-bold" style={{display: 'flex', alignItems: 'center', gap: '0.5rem'}}
            >
              <input
                type="radio"
                name="priority"
          ...
          {filteredNotes.length !== 0 ? (
            ...
            <h1 style={{marginTop: '-35rem', marginLeft: '40rem'}}>No Labels</h1>
          )}
          </div>
        </div>
