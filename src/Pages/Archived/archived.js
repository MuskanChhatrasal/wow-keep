      ...
      <div className="archived-main-container">
        {archivedNotes.length === 0 ? (
          ...
          archivedNotes.map((note) => {
            return (
              <div
                className="archived-container"
                style={{ marginTop: "-46.5rem", marginBottom: "40rem" }}
              >
                <div
                  className="archived-display-card pd-1"
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() => {
                        restoreFromArchive(note._id);
                      }}
                    >
                      <span className="material-icons-outlined btn-archive">
                        unarchive
                      </span>
                    </button>
                    <button
                      className="btn-transparent"
                      onClick={() => {
                        deleteFromArchive(note._id);
                      }}
                    >
                      <span className="material-icons-outlined btn-delete">
                        delete
                      </span>
                    </button>
                  </div>
